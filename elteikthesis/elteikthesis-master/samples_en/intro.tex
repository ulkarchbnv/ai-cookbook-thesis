...
Chapter 3 presents the design documentation, covering the software
requirements, system architecture, data model, and user interface design.

Chapter 4 presents the implementation details of the application, including
the frontend and backend realization of the main workflows and supporting
services.

Chapter 5 presents the testing methodology and results, including automated,
manual, and AI-specific evaluation material used to validate the system.
