...
This section documents the executed tests for the implemented system.
...
For this reason, the evaluation includes a dedicated set of manual test
cases covering the main user-facing flows of the application rather than
only isolated controls. The goal of this layer is to confirm that the
implemented features can be completed successfully as end-to-end user
tasks and to support the thesis with screenshot-based evidence.
...
The concrete evidence for these scenarios is distributed across the
earlier figures in this chapter: Figures~\ref{fig:ui-home-login},
\ref{fig:ui-account-generate}, and \ref{fig:ui-history-saved-ocr}
document the visible page-level results of login, account, generation,
history, and OCR workflows from the perspective of the end user.
